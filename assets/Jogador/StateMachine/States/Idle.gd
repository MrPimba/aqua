...
func physics_update(_delta: float) -> void:
	...
	if Input.is_action_just_pressed(UP) or Input.is_action_just_pressed("move_down") or Input.is_action_just_pressed("move_right") or Input.is_action_just_pressed("move_left"):
